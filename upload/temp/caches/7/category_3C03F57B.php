 ...
 <div class="box_1">
  ...
  <input type="hidden" name="order" value="DESC" />
    ...
    <div class="clearfix goodsBox" style="border:none;">
             <div class="goodsItem">
           <a href="goods.php?id=33"><img src="images/no_picture.gif" alt="小时工" class="goodsimg" /></a><br />
           <p><a href="goods.php?id=33" title="小时工">小时工</a></p>
           ...
           <a href="javascript:;" id="compareLink" onClick="Compare.add(33,'小时工','10')" class="f6">比较</a>
        </div>
                    </div>
    </div>
        </form>

...
<title>配送支付智能查询 _配送与支付 _网店帮助分类_系统分类_ECSHOP演示站 - Powered by ECShop</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="article_cat.php?id=1">系统分类</a> <code>&gt;</code> <a href="article_cat.php?id=3">网店帮助分类</a> <code>&gt;</code> <a href="article_cat.php?id=7">配送与支付 </a> <code>&gt;</code> 配送支付智能查询  </div>
</div>
<div class="blank"></div>
    ...
    <div class="box">
     <div class="box_1">
      <div style="border:4px solid #fcf8f7; background-color:#fff; padding:20px 15px;">
         ...
         <font class="f5 f6">配送支付智能查询 </font><br /><font class="f3">ECSHOP / 2009-05-18</font>
         </div>
                           <div style="padding:8px; margin-top:15px; text-align:left; border-top:1px solid #ccc;">
         
                      下一篇:<a href="article.php?id=17" class="f6">支付方式说明</a><br />
                    
                      上一篇:<a href="article.php?id=15" class="f6">货到付款区域</a>
                   </div>
      </div>
    </div>
  </div>
